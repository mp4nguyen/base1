...
module.exports = function(CRosters) {
    ...
    CRosters.generateRoster = function(def, cb) {
        ...
        if(!currentUser){
          ...
          console.log('CRosters.generateRoster currentUser=',currentUser);
          ...
          CRosters.beginTransaction({isolationLevel: CRosters.Transaction.READ_COMMITTED}, function(errTran, tx) {
              if(errTran){
                ...
                CRosters.find({where:{doctorId:def.doctorId,dayOfWeek:pFromDate.format('dd'),fromDate:{between:[pFromDate,pToDate]}}},function(err,data){
                  ...
                  if(oldRosterIds.length > 0){
                            ...
                            if(err){
                              ...
                              CRosters.app.models.CCalendars.destroyAll({rosterId:{inq:oldRosterIds},calendarId:{nin:calIds}},{transaction: tx},function(err,data){
                                ...
                                if(err){
                                  ...
                                  generateRoster(currentUser,tx,def,cb,existingRosters);
                                }
                              });
                            }
                          });
                      ...
                      //begin new roster
                      generateRoster(currentUser,tx,def,cb);
                      //End new roster
                    }
                });
                //////////////////////////////////////////////////////////////////////////
    ...
    var generateRoster = function(currentUser,tx,def,cb,existingRosters){
      //Begin gen roster
      var repeatType = def.repeatType;
      var fromDate = moment(def.fromDate);
      var toDate = moment(def.toDate);
      ...
      while(rosterDate.isSameOrBefore(toDate)){
          ...
          roster.fromDate = moment(rosterDate.format('YYYY-MM-DD') + ' ' + fromTime,'YYYY-MM-DD HH:mm:ss').toDate();
          roster.toDate = moment(rosterDate.format('YYYY-MM-DD') + ' ' + toTime,'YYYY-MM-DD HH:mm:ss').toDate();
      ...
      console.log('will create rosters = ',rosters);
